...
malha_b['preds_gpr_05'] = preds_gpr - 1.9600 * preds_std
malha_b['preds_gpr'] = preds_gpr
malha_b['preds_gpr_95'] = preds_gpr + 1.9600 * preds_std

malha_b.to_csv('predictions/malha_B_1024x1024.csv', index=False)


# Malha A
print('Malha A 200x200')
malha_a = pd.read_csv('malhas/mapa-A-200x200.csv')
...
malha_a.to_csv('predictions/malha_A_200x200.csv', index=False)


# Malha A
print('Malha B 200x200')
malha_b = pd.read_csv('malhas/mapa-B-200x200.csv')
...
malha_b.to_csv('predictions/malha_B_200x200.csv', index=False)
